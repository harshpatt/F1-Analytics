...
Tell Claude:
> "Continue my F1 analytics project. Plan is in `C:\Users\harsh\Desktop\f1-analytics\PROJECT_PLAN.md`. Notebook 01 is done. Build notebook 02."

Driver codes: `VER` = Verstappen, `PIA` = Piastri.  
Cache path: `C:\Users\harsh\Desktop\f1-analytics\cache`
